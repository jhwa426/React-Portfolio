        ...
        <section id="AboutMe">
            ...
            <div className="container about__container">
                ...
                <div className="about__content">
                    <div>
                        <p>Kia ora, welcome to my website! I'm an undergraduate student at the <a href="https://www.auckland.ac.nz/" target="_blank" rel="noopener noreferrer" style={{ color: "cornflowerblue" }} >University of Auckland</a>, New Zealand.</p>
